    ...
    <div class="row justify-content-center">
      <div class="col-xl-12">
        <div class="card card-default">
          <div class="card-header">Create Barang dari Pengajuan User</div>
...
export default {
  ...
  created() {
    axios.get("/api/pengajuan/" + this.$route.params.id).then((response) => {
      ...
      this.barang.nama_barang = this.pengajuan.nama_barang;
      this.barang.detail_barang = this.pengajuan.detail_barang;
  ...
  methods: {
    BarangStore() {
      ...
      axios
        ...
        .then((response) => {
          axios
            .delete(`/api/pengajuan/` + this.$route.params.id)
            .then((response) => {
              this.$router.push("/pengajuan/admin");
            });
        })
        .catch((errors) => {
          console.log(errors);
